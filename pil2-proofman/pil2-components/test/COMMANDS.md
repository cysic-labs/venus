...
&& cargo run --release --bin pil2c -- ./pil2-components/test/simple/simple.pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/connection/connection.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/diff_buses/diff_buses.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/direct_update/direct_update.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/lookup/lookup.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/one_instance/one_instance.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/permutation/permutation.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/range_check/build.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/virtual_tables/virtual_tables.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/special/array_size.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/special/direct_optimizations.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/special/expr_optimizations.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/special/intermediate_prods.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/special/intermediate_sums.pil \
     -I ./pil2-components/lib/std/pil \
...
&& cargo run --release --bin pil2c -- ./pil2-components/test/special/openings.pil \
     -I ./pil2-components/lib/std/pil \
     -u ./pil2-components/test/special/build/fixed_openings -O fixed-to-file \
     -o ./pil2-components/test/special/build/openings.pilout \
&& cargo run --release --bin pil2c -- ./pil2-components/test/special/table.pil \
     -I ./pil2-components/lib/std/pil \
