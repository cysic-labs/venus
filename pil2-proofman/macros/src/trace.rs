...
// Thin wrapper called by crate root (lib.rs)
pub(crate) fn trace_entrypoint(input: TokenStream) -> TokenStream {
...
pub(crate) fn values_entrypoint(input: TokenStream) -> TokenStream {
