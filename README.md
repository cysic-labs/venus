...
|---|---|---|
| Root (ZisK core) | [0xPolygonHermez/zisk](https://github.com/0xPolygonHermez/zisk) | zkVM core: state machines, emulator, executor, PIL definitions, CLI tools |
...
| **`venus/`** | **Cysic Labs** | **FPGA/ASIC acceleration backend (Cysic original work)** |
...
**Attribution**: All code outside the `venus/` directory was developed by and should be credited to the [0xPolygonHermez](https://github.com/0xPolygonHermez) team and the ZisK project. Cysic has contributed a small number of bug fixes and cudaGraph-based optimizations under `pil2-proofman/`.
